...
const Contact_IconsContainer = () => {
  ...
  return (
    <section className="flex items-center gap-8 md:gap-16 lg:gap-32">
      ...
      <Contact_Icon href={dataContact.linkedin} Icon={FaLinkedinIn} size={74} className="text-blue-600 hover:text-blue-800 dark:text-blue-600 dark:hover:text-blue-400" />
