  ...
  return (
    <section className="flex flex-wrap items-center justify-center gap-4 md:gap-8 lg:gap-16">
      <Contact_Icon
        ...
        Icon={BiLogoGmail}
        size={74}
        className="text-red-500 hover:text-red-700 dark:text-red-700 dark:hover:text-red-500"
        title={dataContact.gmail}
      />
      {/* To add the Whatsapp again, add the data to dataContact.js */}
      ...
      <Contact_Icon
        ...
        title="github.com/gastondvoskin"
      />
      <Contact_Icon
        ...
        title="linkedin.com/in/gaston-dvoskin"
      />
    </section>
  );
};
